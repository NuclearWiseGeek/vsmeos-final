...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 selection:bg-blue-100 antialiased scroll-smooth">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-50">
        <div className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-12 text-[11px] font-bold uppercase tracking-[0.2em] text-gray-400">
            {/* Using standard <a> tags for internal anchors ensures better repeat-click behavior */}
      ...
      {/* 2. THE PRECISION HERO (Added pt-32 to account for fixed nav) */}
      <main className="max-w-7xl mx-auto px-8 pt-48 pb-40">
        ...
        <div className="mt-32 pt-10 border-t border-gray-100">
          <div className="flex flex-wrap items-center gap-x-16 gap-y-8 opacity-30 grayscale hover:opacity-50 transition-opacity">
            <div className="flex flex-col">
              <span className="text-[9px] font-bold uppercase tracking-widest mb-1 text-gray-400">Standard</span>
              <span className="text-xl font-bold tracking-tighter italic text-black">GHG Protocol</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] font-bold uppercase tracking-widest mb-1 text-gray-400">Certification</span>
              <span className="text-xl font-bold tracking-tighter text-black">ISO 14064-1</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] font-bold uppercase tracking-widest mb-1 text-gray-400">Reporting Framework</span>
              <span className="text-xl font-bold tracking-tighter text-black">CSRD ESRS E1</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] font-bold uppercase tracking-widest mb-1 text-gray-400">Validated Database</span>
      ...
      {/* Scroll-mt-32 ensures the section doesn't hide behind the sticky nav */}
      <section className="max-w-7xl mx-auto px-8 py-32 border-t border-gray-50">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          
          {/* PILLAR 1: METHODOLOGY */}
          <div id="methodology" className="scroll-mt-32 space-y-6 group">
          ...
          {/* PILLAR 2: FRAMEWORK */}
          <div id="framework" className="scroll-mt-32 space-y-6 group">
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-light">
              ...
              A comprehensive 3-page output covering Scope 1, 2, and selected Scope 3 categories.
            </p>
          </div>

          {/* PILLAR 3: ALIGNMENT */}
          <div id="alignment" className="scroll-mt-32 space-y-6 group">
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-light">
              Every quantification is structured to align with <span className="text-black font-medium">GHG Protocol</span> Standards and <span className="text-black font-medium">ISO 14064-1</span>. 
